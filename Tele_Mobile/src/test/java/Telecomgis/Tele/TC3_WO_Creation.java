	...
	public class TC3_WO_Creation extends PlaywrightFactory {
		...
		public static void main(String[] args) {
			...
			try {
				...
				page.getByRole(AriaRole.OPTION, new Page.GetByRoleOptions().setName("Survey & Construction"))
						.locator("span").click();
	
				page.locator("input[name='startdate']").nth(0).fill("2026-05-01");
				page.locator("//label[contains(text(),'End Date')]/following::input[@name='endDate'][1]")
			    .fill("2026-06-19");
				...
				page.getByLabel("Project Details").getByLabel("", new Locator.GetByLabelOptions().setExact(true))
						.locator("svg").click(); 
	
				// *********Enter cluster/design value here*******//
				//page.getByRole(AriaRole.OPTION, new Page.GetByRoleOptions().setName("DGN_00876")).click();
				page.locator("mat-option").filter(new Locator.FilterOptions().setHasText("DGN_00878")).click();
